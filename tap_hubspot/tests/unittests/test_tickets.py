...
def test_ticket_params_are_validated(mocked_gen_request, mocked_catalog_from_id, mocked_get_start,
...
output_results = {'results': [
        {'id': '190756785', 'properties': {'content': 'also a test', 'createdate': '2020-08-26T15:18:14.135Z', 'hs_lastmodifieddate': '2020-11-24T19:45:08.380Z', 'hs_object_id': '190756785', 'hs_pipeline': '0', 'hs_pipeline_stage': '1', 'hs_ticket_category': None, 'hs_ticket_priority': 'MEDIUM', 'subject': 'ticket 2'
            }, 'createdAt': '2020-08-26T15:18:14.135Z', 'updatedAt': '2020-11-24T19:45:08.380Z', 'archived': False, 'associations': {'companies': {'results': [
                        {'id': '635376281', 'type': 'ticket_to_company'
                        },
                        {'id': '635376281', 'type': 'ticket_to_company_unlabeled'
                        }
                    ]
                }, 'deals': {'results': [
                        {'id': '2870386661', 'type': 'ticket_to_deal'
                        }
                    ]
                }, 'contacts': {'results': [
                        {'id': '1', 'type': 'ticket_to_contact'
                        },
                        {'id': '51', 'type': 'ticket_to_contact'
                        },
                        {'id': '101', 'type': 'ticket_to_contact'
                        }
                    ]
                }
            }
