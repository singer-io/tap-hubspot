...
def verify_environment_vars():
    ...
    if len(missing_envs) != 0:
           raise Exception("you must specify the following environmental variables for these tests to operate: TAP_HUBSPOT_REDIRECT_URI, TAP_HUBSPOT_CLIENT_ID, TAP_HUBSPOT_CLIENT_SECRET, TAP_HUBSPOT_REFRESH_TOKEN")
...
def our_write_bookmark(state, table_name, bookmark_key, bookmark_value):
    # LOGGER.info("our_write_bookmark: {} {} {} {}".format(state, table_name, bookmark_key, bookmark_value))
